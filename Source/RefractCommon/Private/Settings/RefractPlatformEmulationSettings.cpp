...
#define LOCTEXT_NAMESPACE "RefractCheats"

URefractPlatformEmulationSettings::URefractPlatformEmulationSettings()
{
}

FName URefractPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName URefractPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName URefractPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void URefractPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void URefractPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void URefractPlatformEmulationSettings::PostInitProperties()
{
...
void URefractPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void URefractPlatformEmulationSettings::ApplySettings()
{
...
void URefractPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> URefractPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> URefractPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void URefractPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
